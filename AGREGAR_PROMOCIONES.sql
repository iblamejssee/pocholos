...
INSERT INTO productos (nombre, tipo, precio, fraccion_pollo, activo, descripcion) VALUES
  ...
  ('Promo: Pollo Entero + Gaseosa 1.5L', 'promocion', 76, 1, true, 'Pollo entero a la brasa + Gaseosa de 1.5 litros (Inca o Coca)'),
  ('Promo: Pollo Entero + Chaufa + Chicha 1L', 'promocion', 83, 1, true, 'Pollo entero a la brasa + Chaufa + Chicha de 1 litro'),
